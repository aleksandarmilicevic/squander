...
import edu.mit.csail.sdg.squander.examples.bst.BST_noSpecFld.Node;
import edu.mit.csail.sdg.squander.util.test.TestUtils;


public class BST_noSpecFldTest extends MySquanderTestBase {

    private BST_noSpecFld bst;
    private int[] keys;
    private Node[] nodes;
...
//        assertEquals("BST changed!", bstStr, bst.toString());
        BST_noSpecFld emptyBst = new BST_noSpecFld();
...
//        assertEquals("BST changed!", bstStr, bst.toString());
    ...
    public void testFindNode_squander() {
        ...
        assertEquals("expected to get null for empty bst", null, new BST_noSpecFld().findNode(nonExistentKey));
    }
    ...
    public void testInsertNode_squander() {
        ...
        BST_noSpecFld bstSq = new BST_noSpecFld();
        for (int i = 0; i < keys.length; i++) {
    ...
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main(BST_noSpecFldTest.class.getName());
    }
